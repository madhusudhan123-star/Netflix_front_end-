...
//       const response = await axios.post(`${REACT_APP_MAIN_URL}/search?query=${searchTerm}`, config);
...
//           <div style={{"justify-items": "center"}} className="grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
