...
//       <button 
//         onClick={() => scroll(-300)} 
//         className='absolute h-80 w-12 left-0 top-1/2 transform -translate-y-1/2 bg-black bg-opacity-50 text-white p-2 rounded-full z-10'>
//         <FaChevronLeft size={24} />
//       </button>
//       <div ref={scrollRef} className='flex gap-5 overflow-x-scroll scrollbar-hide w-full h-full'>
//         {datas ? (
//           <h1 className='text-5xl text-white font-extrabold'>Loading...</h1>
//         ) : (
//           data.map((item, i) => (
//           <div ><Cards  key={i} data={data} /></div>
//           ))
//         )}
//       </div>
//         <button 
//             onClick={() => scroll(300)} 
//             className='absolute h-80 w-12 right-0 top-1/2 transform -translate-y-1/2 bg-black bg-opacity-50 text-white p-2 rounded-full z-10'>
